...
class RVAAdapterStudent(private val context: Context, private val arrayList: ArrayList<Students>) : RecyclerView.Adapter<RVAAdapterStudent.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        return Holder(LayoutInflater.from(parent.context).inflate(R.layout.student_list,parent,false))//ktlin dengan xmlnya
    }
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.view.lbNameList.text = "Nama : "+arrayList?.get(position)?.name// dai ngambil name.
        ...
        holder.view.cvList.setOnClickListener {
            ...
            i.putExtra("editmode","1")//setelah diambil kemudian ditampilkan ke studen list
